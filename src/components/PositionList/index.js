...
const DashGrid = styled.div`
  ...
  grid-template-areas: 'number name aliumswap return';
  ...
  @media screen and (max-width: 740px) {
    ...
    grid-template-areas: 'name aliumswap return';
  }

  @media screen and (max-width: 500px) {
    grid-template-columns: 2.5fr 1fr;
    grid-template-areas: 'name aliumswap';
  }
`
